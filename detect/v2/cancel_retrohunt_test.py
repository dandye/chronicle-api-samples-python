...
#
"""Unit tests for the "cancel_retrohunt" module."""
...
class CancelRetrohuntTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      cancel_retrohunt.cancel_retrohunt(
          mock_session, "ru_12345678-1234-1234-1234-1234567890ab",
          "oh_12345678-1234-1234-1234-1234567890ab")
