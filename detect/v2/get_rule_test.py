...
class GetRuleTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      get_rule.get_rule(mock_session, "ru_12345678-1234-1234-1234-1234567890ab")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    expected_rule_content = "rule content"
    expected_response = {
        "ruleId": "ru_12345678-1234-1234-1234-1234567890ab",
        "rule": expected_rule_content,
    }
    mock_response.json.return_value = expected_response

    got_response = get_rule.get_rule(mock_session,
