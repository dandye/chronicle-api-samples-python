...
#
"""Unit tests for the "disable_live_rule" module."""
...
from . import disable_live_rule


class DisableLiveRuleTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      disable_live_rule.disable_live_rule(
