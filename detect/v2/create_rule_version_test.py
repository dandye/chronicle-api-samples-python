...
#
"""Unit tests for the "create_rule_version" module."""
...
class CreateRuleVersionTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      create_rule_version.create_rule_version(
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    expected_version_id = "ru_12345678-1234-1234-1234-1234567890ab@v_100000_000000"
    expected_rule = {
    ...
    actual_version_id = create_rule_version.create_rule_version(
        mock_session, "ru_12345678-1234-1234-1234-1234567890ab",
        "new rule content")
    self.assertEqual(actual_version_id, expected_version_id)
