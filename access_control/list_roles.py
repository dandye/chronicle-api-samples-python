...
#
"""Executable and reusable sample for retrieving a list of access roles.

API reference:
https://cloud.google.com/chronicle/docs/reference/rbac-api#listroles
"""
...
def list_roles(
  ...
  """Retrieves list of access control roles.

  Args:
    http_session: Authorized session for HTTP requests.

  Returns:
    List of roles in the form:
    {
      "roles": [
        {
          "name": "Test",
  ...
  """
  url = f"{CHRONICLE_API_BASE_URL}/v1/roles/"
...
if __name__ == "__main__":
  ...
  print(json.dumps(list_roles(session), indent=2))
