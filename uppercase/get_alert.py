...
#
"""Executable and reusable sample for retrieving an Uppercase alert.

API reference:
https://cloud.devsite.corp.google.com/chronicle/docs/reference/uppercase-api#getalert
"""
...
def initialize_command_line_args(
  ...
  parser.add_argument(
      "-i", "--id", type=str, required=True, help="alert identifier")
...
if __name__ == "__main__":
  ...
  print(json.dumps(get_alert(session, cli.id), indent=2))
