...
#
"""Executable and reusable sample for retrieving a forwarder."""
...
def get_forwarder(http_session: requests.AuthorizedSession,
                  name: str) -> Mapping[str, Any]:
  """Retrieves a forwarder.
...
if __name__ == "__main__":
  ...
  print(json.dumps(get_forwarder(session, args.name), indent=2))
