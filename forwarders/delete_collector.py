...
#
"""Executable and reusable sample for deleting a collector."""
...
def delete_collector(http_session: requests.AuthorizedSession, name: str):
...
if __name__ == "__main__":
  ...
  delete_collector(session, args.name)
