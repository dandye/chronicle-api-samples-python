...
#
"""Unit tests for the "get_collector" module."""
...
class GetCollectorTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      get_collector.get_collector(mock_session, "collector name")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    actual_collector = get_collector.get_collector(mock_session,
                                                   "collector name")
