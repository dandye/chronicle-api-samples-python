...
#
"""Unit tests for the "generate_files" module."""
...
class GenerateFilesTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      generate_files.generate_files(mock_session, "forwarder name")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    actual_files = generate_files.generate_files(mock_session, "forwarder name")
