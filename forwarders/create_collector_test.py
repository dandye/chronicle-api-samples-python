...
#
"""Unit tests for the "create_collector" module."""
...
class CreateCollectorTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      create_collector.create_collector(mock_session, "forwarder name")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    actual_collector = create_collector.create_collector(
