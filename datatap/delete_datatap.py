...
#
"""Executable and reusable sample for deleting a Datatap.

API reference:
https://cloud.google.com/chronicle/docs/preview/datatap-config/datatapconfig-api?hl=en#delete
"""
...
def delete_datatap(http_session: requests.AuthorizedSession,
                   tap_id: str) -> Mapping[str, Sequence[Any]]:
  """Deletes the given datatap.
...
if __name__ == "__main__":
  ...
  print(
      json.dumps(
          delete_datatap(session, cli.tapId),
          indent=2))
