...
#
"""Tests for the "get_gcp_association" module."""
...
from . import get_gcp_association


class GetGCPAssociationTest(unittest.TestCase):

  def test_initialize_command_line_args(self):
    actual = get_gcp_association.initialize_command_line_args(
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      get_gcp_association.get_gcp_association(mock_session, 123)
