...
#
"""Executable and reusable sample for getting a GCP association.

In Chronicle, customers can associate their GCP organizations with their
Chronicle instances. This example provides a programmatic way to get such
association.
"""
...
def get_gcp_association(http_session: requests.AuthorizedSession,
                        organization_id: int) -> None:
  """Gets a GCP association with Chronicle.
...
if __name__ == "__main__":
  ...
  get_gcp_association(session, cli.organization_id)
