...
#
"""Executable and reusable sample for getting GCP settings.
...
into Chronicle by GCP settings. This example provides a programmatic way to get
such settings.
"""
...
def get_gcp_settings(http_session: requests.AuthorizedSession,
                     organization_id: int) -> None:
  """Gets GCP settings with Chronicle.
...
if __name__ == "__main__":
  ...
  get_gcp_settings(session, cli.organization_id)
