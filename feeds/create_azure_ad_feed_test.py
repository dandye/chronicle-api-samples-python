...
#
"""Unit tests for the "create_azure_ad_feed" module."""
...
from . import create_azure_ad_feed
...
class CreateFeedTest(unittest.TestCase):
  ...
  def test_http_error(self, mock_response, mock_session):
    ...
    with self.assertRaises(requests.requests.exceptions.HTTPError):
      create_azure_ad_feed.create_azure_ad_feed(mock_session,
                                                "tokenendpoint.example.com",
                                                "clientid_example",
                                                "clientsecret_example",
                                                "my feed name")
  ...
  def test_happy_path(self, mock_response, mock_session):
    ...
    actual_feed = create_azure_ad_feed.create_azure_ad_feed(
        mock_session, "tokenendpoint.example.com", "clientid_example",
        "clientsecret_example", "my feed name")
